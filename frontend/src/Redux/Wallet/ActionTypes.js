...
export const LOAD_DEMO_BALANCE_REQUEST = 'LOAD_DEMO_BALANCE_REQUEST';
export const LOAD_DEMO_BALANCE_SUCCESS = 'LOAD_DEMO_BALANCE_SUCCESS';
export const LOAD_DEMO_BALANCE_FAILURE = 'LOAD_DEMO_BALANCE_FAILURE';
