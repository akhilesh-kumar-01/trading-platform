...
public class OrderServiceImplementation implements OrderService {
    ...
    public Order createOrder(User user, OrderItem orderItem, OrderType orderType) {
        ...
        order.setDemoOrder(user.isDemoAccount());
    ...
    @Override
    public List<Order> getAllOrdersForUser(Long userId, String orderType, String assetSymbol, boolean isDemoOrder) {
        List<Order> allUserOrders = orderRepository.findByUserIdAndIsDemoOrder(userId, isDemoOrder);
