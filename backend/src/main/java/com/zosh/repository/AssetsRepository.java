...
public interface AssetsRepository extends JpaRepository<Asset,Long> {
   ...
   public List<Asset> findByUserIdAndIsDemoAsset(Long userId, boolean isDemoAsset);

   Asset findByUserIdAndCoinId(Long userId, String coinId);
   Asset findByUserIdAndCoinIdAndIsDemoAsset(Long userId, String coinId, boolean isDemoAsset);
